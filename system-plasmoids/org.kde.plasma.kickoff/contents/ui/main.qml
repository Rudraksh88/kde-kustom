...
PlasmoidItem {
    ...
    compactRepresentation: MouseArea {
        ...
        readonly property bool shouldHaveLabel: Plasmoid.formFactor !== PlasmaCore.Types.Vertical && Plasmoid.configuration.menuLabel !== ""
                ...
                property int iconSize: Plasmoid.configuration.iconSize // Default: 48
        ...
        readonly property var sizing: {
            ...
            if (shouldHaveLabel) {
                impWidth += labelTextField.contentWidth + labelTextField.Layout.leftMargin + labelTextField.Layout.rightMargin;
                    ...
                    const impHeight = iconSize //displayedIcon.height > 0 ? displayedIcon.height : iconSize
        ...
        Layout.preferredWidth: sizing.preferredWidth
                Layout.preferredHeight: iconSize//height / (implicitHeight / implicitWidth)sizing.preferredHeight
        ...
        RowLayout {
            ...
            Kirigami.Icon {
                ...
                Layout.preferredWidth: iconSize //kickoff.vertical ? -1 : iconSize //height / (implicitHeight / implicitWidth)
                Layout.preferredHeight: iconSize //!kickoff.vertical ? -1 : iconSize /*width * (implicitHeight / implicitWidth)*/
                Layout.maximumHeight: Kirigami.Units.iconSizes.huge
                Layout.maximumWidth: Kirigami.Units.iconSizes.huge
                        Layout.minimumWidth: Plasmoid.configuration.buttonWidth // Expanded width for corner clickable
                ...
                selected: kickoff.expanded

                // On hover, change the svg color to white
                opacity: active || selected ? 0.6 : 0.38
