...
KCM.SimpleKCM {
    ...
    property int cfg_buttonWidth: Plasmoid.configuration.buttonWidth
    ...
    Kirigami.FormLayout {
        ...
        // Icon size input field
        QQC2.SpinBox {
            id: iconSize
            Kirigami.FormData.label: i18n("Icon size:") // Input field label
            from: 1
            to: 100
            value: Plasmoid.configuration.iconSize
            stepSize: 1
            width: Kirigami.Units.gridUnit * 5
            onValueChanged: root.cfg_iconSize = iconSize.value
        }

        QQC2.Label {
            text: i18nc("@info", "The size of the launcher button icon. The default is 48.")
            wrapMode: Text.Wrap
        ...
        // Button width input field
        QQC2.SpinBox {
            id: buttonWidth
            Kirigami.FormData.label: i18n("Button width:") // Input field label
            from: 1
            to: 100
            value: Plasmoid.configuration.buttonWidth
            stepSize: 1
            width: Kirigami.Units.gridUnit * 5
            onValueChanged: root.cfg_buttonWidth = buttonWidth.value
        }


        QQC2.Label {
            text: i18nc("@info", "The width of the launcher button. The default is 35.")
            wrapMode: Text.Wrap
            font: Kirigami.Theme.smallFont
        }
