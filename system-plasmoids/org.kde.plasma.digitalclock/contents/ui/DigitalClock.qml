    ...
    Item {
        ...
        Grid {
            ...
            PlasmaComponents.Label  {
                ...
                color: 'white'
                // opacity: main.containsMouse || root.expanded ? 0.73 : 0.58
                opacity: main.containsMouse || root.expanded ? 0.32 : 0.25
        ...
        PlasmaComponents.Label {
            ...
            font: Qt.font({
                ...
                weight: fontHelper.font.weight,
                italic: fontHelper.font.italic,
                features: { "ss01": 1, 'cpsp': 1 },
                pixelSize: 1024,
                // letterSpacing: 0.4
            })

            color: 'white'
            // opacity: main.containsMouse || root.expanded ? 0.73 : 0.58 // Previous one without layer effects
            opacity: main.containsMouse || root.expanded ? 0.32 : 0.25
