...
ContainmentItem {
    ...
    MouseArea {
        ...
        Rectangle {
            ...
            // Only when the full representation is visible and the plasmoid is in the hidden layout
            // opacity: systemTrayState.expanded && expandedRepresentation.hiddenLayout.currentIndex >= 0 ? 1.0 : 0.0
        ...
        GridLayout {
            ...
            GridView {
                ...
                // Add some left padding to the grid to make it look better
                ...
                // readonly property int cellSpacing: (Kirigami.Units.smallSpacing + 1.6) * (Kirigami.Settings.tabletMode ? 6 : Plasmoid.configuration.iconSpacing) // DEFAULT icon spacing (+ 1.6)
                readonly property int cellSpacing: (5.1) * (Kirigami.Settings.tabletMode ? 6 : Plasmoid.configuration.iconSpacing)
                ...
                readonly property int itemSize: {
                    if (autoSize) {
                        ...
                        return smallIconSize + 2 // Make the icon a bit bigger to make it look better
                    }
                }
